...
public class FileUploadUtil {
    ...
    public static String upload(MultipartFile file) throws IOException {
        ...
        String templatePath = path+"/excel";
        //获取文件名
        ...
        System.out.println("文件在项目下的地址为："+dest.getAbsolutePath());
        return dest.getAbsolutePath();
    }
//    public Map<String,Object> upload2(MultipartFile file) throws UnsupportedEncodingException {
